...
def run_client(server_ip: str, server_port: int) -> None:
    ...
    while True:
        pkt = sock.recv(65535)
        src_ip, src_port, dst_port, seq_in, ack_in, flags, _ = parse_pkt(pkt)
        if src_port == server_port and dst_port == local_port:
    ...
    try:
        while True:
            ...
            try:
                ...
                if src_ip == actual_server_ip and src_port == server_port and dst_port == local_port:
                    if flags & FIN:
